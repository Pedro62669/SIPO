    ...
    @else
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between mb-3">
                <h3 class="text-sm font-semibold text-gray-900">Parametrização da sua secretaria</h3>
            ...
            <div class="overflow-x-auto rounded-lg border border-gray-200">
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-6 text-center text-gray-500">Nenhuma parametrização histórica importada.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="rounded-lg border border-gray-200 overflow-x-auto">
            ...
            <table class="min-w-full divide-y divide-gray-200 text-xs whitespace-nowrap loa-table-user">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="13" class="px-3 py-8 text-center text-gray-400 text-sm">Nenhum registro encontrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
